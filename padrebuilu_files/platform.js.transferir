...
(function () {
    ...
    var la = -1 != m.indexOf("Opera"),
        p = -1 != m.indexOf("Trident") || -1 != m.indexOf("MSIE"),
        ma = -1 != m.indexOf("Edge"),
        na = -1 != m.indexOf("Gecko") && !(-1 != m.toLowerCase().indexOf("webkit") && -1 == m.indexOf("Edge")) && !(-1 != m.indexOf("Trident") || -1 != m.indexOf("MSIE")) && -1 == m.indexOf("Edge"),
        oa = -1 != m.toLowerCase().indexOf("webkit") && -1 == m.indexOf("Edge"),
        pa = function () {
            var a = aa.document;
    ...
    var D = function (a, b, c) {
        ...
        Pa = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
        Qa = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"),
        ...
        Wa = new RegExp(/\/?\??#?/.source + "(" + /[\/?#]/i.source + "|" + /[\uD800-\uDBFF]/i.source + "|" + /%[c-f][0-9a-f](%[89ab][0-9a-f]){0,2}(%[89ab]?)?/i.source + "|" + /%[0-9a-f]?/i.source + ")$", "i"),
        Xa = function (a, b) {
            var c = E(b);
            b = c.v;
    ...
    var rb = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        yb = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
        xb = /\/cb=/g,
        wb = /\/\//g,
        Eb = function () {
            var a = fb(Aa.href);
    ...
    var N = function (a) {
        ...
        P = function (a, b, c) {
            if (b && "object" === typeof b)
                for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Ob(a[d]) && !Ob(b[d]) ? P(a[d], b[d]) : b[d] && "object" ===
    ...
    var ec;
    var fc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//,
        gc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/b\/(\d{10,21})\//,
        hc = function (a) {
    ...
    var Uc = {
        ...
        Xc = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        Yc = w(F, "WI", x()),
        Zc = function (a, b, c) {
            var d;
            var e = {};
        ...
        id = function (a, b, c, d) {
            ...
            if (kd(fd || {}))
                for (var u in c) {
                    ...
                    d = [];
                    for (u in c)
                        for (a = c[u], n = 0, b = a.length; n < b; n++) e = a[n], md(u, e, bd(e), d, b);
                    nd(r, d)
                }
        },
        od = function (a) {
    ...
    var wd = /^\{h\:'/,
            ...
            function d(d) {
                ...
                if (zd(f, b)) {
                    ...
                    Ad(a, function () {
                        k && G("rqd");
                        c();
                        for (var a = w(F, "RPMQ", []), b = 0; b < a.length; b++) a[b]({
                            data: f,
                            origin: h
                        })
                    })
        ...
        zd = function (a, b) {
            ...
            if (d.s && a && -1 != Da.call(b, a)) {
                if ("_renderstart" === d.s || d.s === yd + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = v.getElementById(a), dc(a, 2), d && b && d.width && d.height) {
                        a: {
                            c = b.parentNode;
                            var e;a = d || {};
                            if (ac() && (e = b.id)) {
    ...
    var Ed = "https:" === window.location.protocol,
        Fd = Ed || "http:" === window.location.protocol ? X : Dd,
        Gd = function (a) {
            var b = a.substr(1),
                c = "",
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.pt_PT.6-2ft3lYTzw.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPU7Vgbj2rqbebXWR3s4Vduel7s7w",
            "u": "https://apis.google.com/js/platform.js",
            "hee": true,
            "fp": "b0caeb71684b7416b689eb7067d10c8d07de7546",
            "dpo": false
        },
