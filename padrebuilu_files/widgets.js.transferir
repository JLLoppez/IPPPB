! function () {
	Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function (t) {
		...
		return e.e = function (t, e) {}, e.e = function (t, n) {
			...
			if (void 0 !== i[t]) i[t].push(n);
				...
				o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function () {
					...
					2: "c794c32aa66923d37742ceab3914757c",
					3: "bf75a4f02bb7953592920d8ecfaf5cc8",
					4: "f634f931f3ad367714fba529027805cf",
					5: "8a5ace5a7a67157b04ea600d59b2a9c7",
					6: "a3df0b22c7410afb111fd9e6736adf22",
					7: "74c74c93b302692d8c120f335037f7a2"
		...
		function u(t, e) {
			return t = t || m, e = e || g, t.postMessage && !(i(e) && t.opener)
		}

		function c(t, e, n) {
			return t = t || m, e = e || p, n = n || g, "ontouchstart" in t || /Opera Mini/.test(n) || e.msMaxTouchPoints > 0
		}
		...
		function o(t) {
			if (0 !== t.length) {
				...
				var e = c(t, function (t) {
					...
					n = e.true,
					o = e.false;
				n && n.length > 0 && r(n.slice(0, 1)), (1 === o.length ? r : i)(o)
			}
		}
		...
		t.exports = [n(75), n(108), n(124), n(158), n(165), n(171), n(223), n(234), n(239)]
	}, function (t, e, n) {
		function r(t) {
		...
		t.exports = {
			css: "bd51c8db901e4a81769550604a33c7f3"
		}
	}, , function (t, e, n) {
		function r(t) {
				...
				function o(t, e) {
					...
					var a, s, u = t.resizeSensor.childNodes[0],
						...
						f = (d.childNodes[0], function () {
							c.style.width = u.offsetWidth + 10 + "px", c.style.height = u.offsetHeight + 10 + "px", u.scrollLeft = u.scrollWidth,
								u.scrollTop = u.scrollHeight, d.scrollLeft = d.scrollWidth, d.scrollTop = d.scrollHeight, a = t.offsetWidth, s = t.offsetHeight
						});
					f();
					var l = function () {
		...
		var r = n(11);
		t.exports = r.aug({}, n(254), n(256), n(257), n(258), n(259), n(260), n(261), n(262), n(263))
	}, function (t, e, n) {
		var r = n(81),
			i = n(255),
			o = i(["userId"], {}, r);
