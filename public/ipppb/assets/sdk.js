/*1502792219,,JIT Construction: v3226970,pt_BR*/
...
try {
            ...
            with(this) {
                ...
                __d('DOMEventListener', ['emptyFunction', 'invariant', 'wrapFunction'], (function a(b, c, d, e, f, g, h, i, j) {
                    ...
                    if (window.addEventListener) {
                        m = function p(q, r, s) {
                            var t = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
                ...
                __d('Flash', ['DOMEventListener', 'DOMWrapper', 'QueryString', 'UserAgent_DEPRECATED', 'guid', 'htmlSpecialChars'], (function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var u = {
                        embed: function v(w, x, y, z) {
                            ...
                            var ba = [];
                            for (var ca in y)
                                if (Object.prototype.hasOwnProperty.call(y, ca) && y[ca]) ba.push('<param name="' + m(ca) + '" value="' + m(y[ca]) + '">');
                        ...
                        function p(t, u) {
                            return function () {
                                ...
                                try {
                                    ...
                                    var v = i(x);
                                    v.entry = u;
                                    var w = ES(Array.prototype.slice.call(arguments), 'map', true, function (y) {
                                        var z = Object.prototype.toString.call(y);
                                        return /^\[object (String|Number|Boolean|Object|Date)\]$/.test(z) ? y : y.toString();
                                    });
                                    v.args = ES('JSON', 'stringify', false, w).substring(0, 200);
                                    o(v);
                                } finally {
                                    n = '';
                                }
                ...
                __d('ApiClientUtils', ['ArgumentError', 'Assert', 'Log', 'sdk.URI', 'flattenObject', 'sprintf'], (function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    function o(p) {
                        ...
                        i.isTrue(Object.prototype.hasOwnProperty.call(n, t), m('Invalid method passed to ApiClient: %s', t));
                        var u = s['function'];
                ...
                __d('ApiBatcher', ['ApiClientUtils', 'QueryString', 'invariant', 'sdk.safelyParseResponse'], (function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    n.prototype.$ApiBatcher5 = function () {
                        ...
                        this.executeRequest('/', 'POST', {
                            ...
                            } else ES(p, 'forEach', true, function (u) {
                                return u({
                                    error: {
                ...
                __d('ApiClient', ['ApiBatcher', 'ApiClientUtils', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'UrlMap', 'ApiClientConfig'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    ...
                    function ea(ka, la, ma, na, oa, pa) {
                        if (pa && pa.error) ia.inform('request.error', la, ma, na, pa, ES('Date', 'now', false) - oa);
                        ia.inform('request.complete', la, ma, na, pa, ES('Date', 'now', false) - oa);
                        z--;
                        if (ka) ka(pa);
                    ...
                    function fa() {
                        for (var ka = arguments.length, la = Array(ka), ma = 0; ma < ka; ma++) la[ma] = arguments[ma];
                        var na = i.parseCallDataFromArgs(la),
                            ...
                            ra = qa.method;
                        if (ja(oa, ra)) ra = 'post';
                        var sa = oa.getProtocol() && oa.getDomain() ? oa.setQueryData({}).toString() : r.resolve('graph') + oa.getPath();
                        ia.inform('request.prepare', sa, qa);
                        da(sa, ra == 'get' ? 'get' : 'post', qa, ES(ea, 'bind', true, null, pa, oa.getPath(), ra, qa, ES('Date', 'now', false)));
                    }
                    ...
                    function ha(ka, la) {
                        ...
                        var na = ma in x ? 'api_read' : 'api',
                            ...
                            pa = ES(ea, 'bind', true, null, la, '/restserver.php', 'get', ka, ES('Date', 'now', false));
                        da(oa, 'get', ka, pa);
                    }
                ...
                __d('sdk.AppEvents', ['AppUserPropertyAPIBuiltinField', 'Assert', 'sdk.Event', 'sdk.Impressions', 'sdk.Model', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function fa(ta) {
                        i.isTrue(s.test(ta), 'Invalid event name: ' + ta + '. ' + 'It must be between 1 and ' + t + ' characters, ' + 'and must be contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _.');
                    }
                    ...
                    function ja(ta) {
                        i.isTrue(ta.length !== 0, 'User ID must be set before updateUserProperties can be called.');
                        i.isTrue(ta.length <= w, 'Invalid user ID: ' + ta + '. ' + 'It must be no longer than ' + w + ' characters.');
                    }
                    ...
                    function na(ta) {
                        i.isTrue(ta.length <= x, 'Invalid app version: ' + ta + '. ' + 'It must be no longer than ' + x + ' characters.');
                    }
                    ...
                    function ra(ta) {
                        i.isTrue(ES('Object', 'keys', false, ta).length <= y, 'The total number of user properties cannot exceed ' + y + '.');
                        for (var ua in ta) {
                            i.isTrue(u.test(ua) || ES(aa, 'includes', true, ua), 'Invalid user properties key name: ' + ua + '. ' + 'It must be between 1 and ' + v + ' ' + 'characters, and must contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _. ' + 'Or, it must be a pre-defined user property');
                            i.isTrue(ta[ua].toString().length <= z, 'Invalid user properties value: ' + ta[ua] + '. ' + 'It must be no longer than ' + z + ' characters.');
                        }
                    }
                    ...
                    j.subscribe('init:post', function (ta) {
                        if (m.getClientID()) {
                            if (ta.autoLogAppEvents !== undefined) {
                                i.isBoolean(ta.autoLogAppEvents, 'Type of property autoLogAppEvents must be boolean');
                ...
                __d('sdk.Dialog', ['sdk.Canvas.Environment', 'sdk.Content', 'sdk.DialogUtils', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    var y = o.extend({
                            ...
                            trackEvents: function aa(ba) {
                                ...
                                for (var ca in ba)
                                    if (Object.prototype.hasOwnProperty.call(ba, ca)) this.trackEvent(ca, ba[ca]);
                                return this;
                            }
                        }, m),
                        z = {
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'sdk.fbt', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'sdk.openMessenger', 'resolveURI'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea) {
                    ...
                    var ka = {
                        ...
                        prepareCall: function la(ma, na) {
                            ...
                            if (wa === 'parent' || wa === 'opener') ES('Object', 'assign', false, ta.params, {
                                channel_url: ka._xdChannelHandler(qa, wa === 'parent' ? 'parent.parent' : 'opener')
                            }, true);
                        ...
                        prepareParams: function la(ma) {
                            ...
                            ma.params.kid_directed_site = r.getKidDirectedSite() || ma.params.kid_directed_site;
                    ...
                    var u = m.extend({
                            ...
                            _setupAuthRefresh: function w() {
                                i.getLoginStatus(ES(function (x) {
                                    var y = x.status;
                                    l.subscribe('auth.statusChange', ES(function (z) {
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3226970","namespace":"FB","message":"' + e.message + '"}}');
}